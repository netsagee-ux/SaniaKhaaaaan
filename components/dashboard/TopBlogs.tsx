...
function TopBlogs({ data = [] }: { data?: [string, number][] }) {
  ...
  useEffect(() => {
    ...
    // Resize observer for accuracy without heavy listeners
          ...
          data.map(([slug, count], i) => (
            ...
            >
              ...
              <div className="flex gap-3 items-center max-w-[70%]">
                <span className="text-xs font-bold text-indigo-500 w-6">
                  #{i + 1}
                </span>
